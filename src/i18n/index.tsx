...
const catalogs: Record<Exclude<Locale, 'en'>, Catalog> = {
  es: {
    ...
    'Use or Description': 'Uso o descripción', 'Repayment Interval': 'Intervalo de pago', 'Currency Loss': 'Pérdida por divisa', 'Bonus Credit': 'Crédito de bonificación',
    'Empty Basket': 'Vaciar cesta', 'Remove Selected': 'Quitar selección', 'Checkout at Kiva': 'Finalizar en Kiva', 'Basket: {count} loans ${amount}': 'Cesta: {count} préstamos ${amount}',
    ...
    'Search by name...': 'Buscar por nombre…', Status: 'Estado', Region: 'Región', Religion: 'Religión', 'Charges Interest': 'Cobra intereses',
    ...
    Lend: 'Prestar', Details: 'Detalles', Repayments: 'Pagos', Description: 'Descripción', 'Matches Saved Searches': 'Coincide con búsquedas guardadas', Posted: 'Publicado', Expires: 'Vence', Disbursed: 'Desembolsado', Borrowers: 'Prestatarios', Female: 'Mujer', Male: 'Hombre',
  ...
  fr: {
    ...
    'Use or Description': 'Usage ou description', 'Repayment Interval': 'Fréquence de remboursement', 'Currency Loss': 'Perte de change', 'Bonus Credit': 'Crédit bonus',
    'Empty Basket': 'Vider le panier', 'Remove Selected': 'Retirer la sélection', 'Checkout at Kiva': 'Finaliser sur Kiva', 'Basket: {count} loans ${amount}': 'Panier : {count} prêts ${amount}',
    ...
    'Search by name...': 'Rechercher par nom…', Status: 'Statut', Region: 'Région', Religion: 'Religion', 'Charges Interest': 'Facture des intérêts',
    ...
    Lend: 'Prêter', Details: 'Détails', Repayments: 'Remboursements', Description: 'Description', 'Matches Saved Searches': 'Correspond aux recherches enregistrées', Posted: 'Publié', Expires: 'Expire', Disbursed: 'Décaissé', Borrowers: 'Emprunteurs', Female: 'Femme', Male: 'Homme',
  ...
  de: {
    ...
    'Use or Description': 'Verwendung oder Beschreibung', 'Repayment Interval': 'Rückzahlungsintervall', 'Currency Loss': 'Währungsverlust', 'Bonus Credit': 'Bonusguthaben',
    'Empty Basket': 'Warenkorb leeren', 'Remove Selected': 'Auswahl entfernen', 'Checkout at Kiva': 'Bei Kiva abschließen', 'Basket: {count} loans ${amount}': 'Warenkorb: {count} Kredite ${amount}',
    ...
    'Search by name...': 'Nach Namen suchen…', Status: 'Status', Region: 'Region', Religion: 'Religion', 'Charges Interest': 'Berechnet Zinsen',
    ...
    Lend: 'Verleihen', Details: 'Details', Repayments: 'Rückzahlungen', Description: 'Beschreibung', 'Matches Saved Searches': 'Passt zu gespeicherten Suchen', Posted: 'Eingestellt', Expires: 'Läuft ab', Disbursed: 'Ausgezahlt', Borrowers: 'Kreditnehmer', Female: 'Weiblich', Male: 'Männlich',
  ...
  it: {
    ...
    'Use or Description': 'Uso o descrizione', 'Repayment Interval': 'Intervallo di rimborso', 'Currency Loss': 'Perdita di cambio', 'Bonus Credit': 'Credito bonus',
    'Empty Basket': 'Svuota carrello', 'Remove Selected': 'Rimuovi selezionato', 'Checkout at Kiva': 'Completa su Kiva', 'Basket: {count} loans ${amount}': 'Carrello: {count} prestiti ${amount}',
    ...
    'Search by name...': 'Cerca per nome…', Status: 'Stato', Region: 'Regione', Religion: 'Religione', 'Charges Interest': 'Applica interessi',
    ...
    Lend: 'Presta', Details: 'Dettagli', Repayments: 'Rimborsi', Description: 'Descrizione', 'Matches Saved Searches': 'Corrisponde alle ricerche salvate', Posted: 'Pubblicato', Expires: 'Scade', Disbursed: 'Erogato', Borrowers: 'Beneficiari', Female: 'Donna', Male: 'Uomo',
  ...
  nl: {
    ...
    'Use or Description': 'Gebruik of beschrijving', 'Repayment Interval': 'Terugbetalingsinterval', 'Currency Loss': 'Valutaverlies', 'Bonus Credit': 'Bonuskrediet',
    'Empty Basket': 'Mandje leegmaken', 'Remove Selected': 'Selectie verwijderen', 'Checkout at Kiva': 'Afronden bij Kiva', 'Basket: {count} loans ${amount}': 'Mandje: {count} leningen ${amount}',
    ...
    'Search by name...': 'Zoeken op naam…', Status: 'Status', Region: 'Regio', Religion: 'Religie', 'Charges Interest': 'Brengt rente in rekening',
    ...
    Lend: 'Uitlenen', Details: 'Details', Repayments: 'Terugbetalingen', Description: 'Beschrijving', 'Matches Saved Searches': 'Komt overeen met opgeslagen zoekopdrachten', Posted: 'Geplaatst', Expires: 'Verloopt', Disbursed: 'Uitbetaald', Borrowers: 'Leners', Female: 'Vrouw', Male: 'Man',
