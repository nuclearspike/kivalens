  ...
  return (
    <Container>
      ...
      <p>
        ...
        is pulled from <NewTabLink href="https://build.kiva.org/api">Kiva.org's Public API</NewTabLink> with the
      ...
      <ul className="spacedList">
        ...
        <li>
          <b>Hide Loans in your portfolio</b> so that you don't accidentally lend to them more
      ...
      <ul className="spacedList">
        ...
        <li>
          ...
          KivaLens user (<LenderLink lender="thomas85717133">Thomas</LenderLink>)
      ...
      <p>
        ...
        me</EmailLink> about
        working on it. It uses React 16 (Hooks), Webpack, react-bootstrap, node, ES6, babel (JSX, ES6 transpiler),
        Kiva API, linqjs, Highcharts, express node js server
        and more. You can check out the source code (in progress)
        at my <NewTabLink href="https://github.com/nuclearspike/kivalens">github
